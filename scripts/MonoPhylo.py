#This script was adopted from MonoPhylo that has been published in: Portik, D.M., and J.J. Wiens. (2020) Do alignment methods matter for phylogenomic (UCE) analyses? Systematic Biology, Advance Access.
...
#    ancestor = tree.get_common_ancestor(tiplist)
    MIDPR=tree.get_midpoint_outgroup()
    #print ancestor
#    tree.set_outgroup(ancestor)
    tree.set_outgroup(MIDPR)
