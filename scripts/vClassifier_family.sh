...
do line=$(echo $aln|sed 's/_ReferenceQuery_aln.fasta//')
    echo $(date)"	Classification for viruses of "$line""
...
echo $(date)"	Step 4: Classification at subfamily rank"
...
echo $(date)"	Step 5: Classification at genus rank"
...
echo $(date)"	Step 6: Classification at species rank"
